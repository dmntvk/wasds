...
def soft():
    ...
    def xpw():
        url = f'https://wasd.tv/api/channels/{channelId}/xp-transfers/amazing-transfers'
        for x in bots:
    ...
    xpw()
    def xpws():
        url = f'https://wasd.tv/api/v2/gifts'
        for x in bots:
            headers = {'accept': 'application/json',
                       'accept-encoding': 'gzip, deflate, br',
                       'content-type': 'application/json',
        ...
        data = {"gift_code":"gift_1","price_id":4,"amount":1,"stream_id":f'{streamid}',"channel_id":f'{channelId}'}
